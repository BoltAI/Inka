...
- Static files, no build step: `index.html`, `changelog.html`, and the privacy policy at `privacy/index.html`. JavaScript is limited to the screenshot strip arrows and the Simple Analytics and DataFast cookieless analytics scripts.
