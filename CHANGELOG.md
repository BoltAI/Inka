...
- Added on-device ML Kit Digital Ink recognition and model download flow.
- Added bring-your-own-key AI provider setup with encrypted local key storage where available.
- Added handwritten replies, ink fade animation, onboarding, local notebook persistence, and BOOX smoke testing.
