...
import co.podzim.inka.brain.ConversationSettings
import co.podzim.inka.brain.DrawingReplyResult
import co.podzim.inka.brain.ErrorMapper
import co.podzim.inka.data.AiProvider
import co.podzim.inka.data.Exchange
import co.podzim.inka.data.HandwritingReplyMode
...
import co.podzim.inka.data.newExchangeId
import co.podzim.inka.data.rebuildApiHistory
import co.podzim.inka.handwriting.HandwritingSynthesisClient
...
import co.podzim.inka.page.DissolveLabStore
...
internal class MainCommitController(
    ...
    private val recognitionService: co.podzim.inka.recognize.RecognitionService,
    ...
    private suspend fun commitDrawingPage() {
        ...
        val latestUserText = when (val outcome = recognitionService.recognize(message, prefs.recognitionLanguage)) {
            is co.podzim.inka.recognize.RecognitionOutcome.Text -> {
            ...
            is co.podzim.inka.recognize.RecognitionOutcome.Failure -> {
                val recognitionMs = SystemClock.elapsedRealtime() - recognitionStartedAt
