...
internal class MainNotebookController(
    ...
    fun startActiveNotebookLoad(
        ...
        notebookLoadJob = scope.launch {
            ...
            if (
                ...
                if (prefs.replyStyle == co.podzim.inka.data.ReplyStyle.Drawing && elements.isNotEmpty()) {
    ...
    fun currentCanvasElements(): List<co.podzim.inka.data.NotebookElement> {
    ...
    fun currentInkElement(strokes: List<co.podzim.inka.data.InkStroke>): co.podzim.inka.data.InkElement {
